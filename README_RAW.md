...
- [BiliTimer](https://github.com/AntiO2/Bili-Timer) - 一个用于统计Bilibili多视频进度的TamperMonkey插件.
...
- [B站优质视频标记](https://github.com/clionertr/bilibili-video-High-quality-video-mark) - 在主页和视频界面计算 点赞数/视频播放量>=0.042 标记为优质，过滤播放量小于1000的新视频.
- [Bilimit](https://github.com/ABitGinger/Bilimit) - 这是一个油猴脚本，旨在通过自主限制，减少在B站无用内容上浪费的时间.
...
- [B站直播间定时发随机弹幕](https://github.com/Gamyou/bilibili-live-random-send) - 定时发送；凌晨打卡；设置随机弹幕；弹幕分组管理；各直播间弹幕互不干扰；无人值守参与、关闭天选时刻；直播间防休眠；隐藏模块简化直播间.
- [BLSPAM](https://github.com/ADJazzzz/BLSPAM) - Bilibili（B站，Bili）直播独轮车脚本.

## 下载工具

- [BilibiliDown](https://github.com/nICEnnnnnnnLee/BilibiliDown) - (GUI-多平台支持)哔哩哔哩视频下载器，支持稍后再看、收藏夹、UP主视频批量下载.jar|exe|cli
- [BilibiliVideoDownload](https://github.com/BilibiliVideoDownload/BilibiliVideoDownload) - 跨平台下载哔哩哔哩视频桌面端软件，支持windows、macOS、Linux.vue|exe
...
- [BiliBiliVideoDownload](https://github.com/IgnatiusGL/BiliBiliVideoDownload) - B站视频下载工具(Windows版).jar|exe
...
- [bilibili](https://github.com/0byteme/bilibili) - 使用golang编写的bilibili视频下载器.go
- [BilibiliAudioDownloader-rebuild](https://github.com/Quandong-Zhang/BilibiliAudioDownloader-rebuild) - b站视频音轨下载器（支持多P）.py|exe
- [bili-fav-sniffer](https://github.com/SummerLiu95/bili-fav-sniffer) - 哔哩哔哩收藏夹嗅探器，定时下载特定收藏夹的新视频到本地.shell|docker
...
- [Bilibili_Downloader_Cli](https://github.com/open17/Bilibili-Downloader-Cli) - 一个轻量的b站下载器,支持下载B站视频,番剧,电影,电视剧等.py|cli|exe
- [BilibiliCacheVideoMergePython](https://github.com/molihuan/BilibiliCacheVideoMergePython) - 将Bilibili缓存文件合并导出为MP4.py|exe
- [BiliTools](https://github.com/btjawa/BiliTools) - 哔哩哔哩工具箱.ts|vue|exe
...
- [BiLiBiLi_DanMu_Crawling](https://github.com/HengXin666/BiLiBiLi_DanMu_Crawling) - 爬取B站历史弹幕/全弹幕, 支持高级弹幕.py|exe
- [bilibili-manga-downloader](https://github.com/lanyeeee/bilibili-manga-downloader) - 哔哩哔哩漫画下载器.rust|exe
- [BiliResourceDownloader](https://github.com/LightQuanta/BiliResourceDownloader) - 多功能B站资源下载器.vue|exe
- [Bilibili_fetcher](https://github.com/Bbdolt/Bilibili_fetcher) - B站资源免费获取、提供在线播放音乐、本地播放音乐，提供GUI界面.py|exe
...
- [BliveCharts](https://github.com/Seyyu0015/BliveCharts) - OBS用直播插件, 直播观众贡献排行榜.py
...
- [BILiveChat.js](https://github.com/XL8Z/BiliBili_BiLiveChat.js) - 基于PlayWithMe_JS二次开发的纯前端弹幕展示板.js
...
- [blive-ws](https://github.com/champkeh/blive-ws) - B站直播间实时弹幕采集.node
...
- [BilibiliLiveNotifier_WPF](https://github.com/ciiim/BilibiliLiveNotifier_WPF) - Bilibili直播通知小工具.c#
...
- [Bilibili-Live-Record](https://github.com/chandou-code/Bilibili-Live-Record) - HTML+Flask 自动爬取up主的《直播回放》 一键实现已看、撤回、更新、多up录播等功能.
- [biliupforjava](https://github.com/mwxmmy/biliupforjava) - 用于b站录播姬，mikufans录播姬，blrec的， 基于WebHook的全自动上传投稿工具,web页面配置.jar|docker
- [BiliLine_GUI](https://github.com/RemKeeper/BiliLine_GUI) - 哔哩哔哩排队姬GUI版本.go|exe
- [bilive](https://github.com/timerring/bilive) - 7 x 24 小时无人监守录制、渲染弹幕、自动上传，启动项目，人人都是录播员.py|cli
- [php-bilibili-danmu](https://github.com/zxc7563598/php-bilibili-danmu) - B站机器人弹幕监控，礼物答谢、定时广告、关注感谢，自动回复等，PHP版本弹幕姬，基于workman.php|cli|docker
- [Bili-LiveLuckDraw](https://github.com/grtsinry43/Bili-LiveLuckDraw) - 一个 B 站直播抽奖工具，通过获取弹幕关键词进行抽奖.ts|exe
- [BiliBili-Live-Recorder](https://github.com/CNXiaozhiy/BiliBili-Live-Recorder) - 哔哩哔哩全自动直播录制器，支持对接适配器（OneBot协议的QQ机器人）.ts

## UP 工具

> 方便 UP 主视频制作、投稿的工具。

- [Biliup-rs](https://github.com/biliup/biliup-rs) - 哔哩哔哩命令行投稿工具，支持多p、线路选择.rust|cli
...
- [biliup-app](https://github.com/biliup/biliup-app) - b站全平台投稿客户端，支持多p投稿.svelte|exe
...
- [bili-music-segmenter](https://github.com/lovegaoshi/bili-music-segmenter) - b站自动录播+歌切+上传脚本，支持docker部署.py|cli|docker
- [youtube2bilibili](https://github.com/assassinliujie/youtube2bilibili) - 油管视频/频道 一键搬运到b站脚本.py
...
- [bili-auth](https://github.com/icyux/bili-auth) - 第三方哔哩哔哩 OAuth API，基于私信鉴权.py
...
- [bililive-rs](https://github.com/LightQuantumArchive/bililive-rs) - Simple stream-based bilibili live client libraries.rust
...
- [biliSDK](https://github.com/yanyvpingsheng/biliSDK) - 哔哩哔哩直播弹幕JAVA-SDK.jar
...
- [bilibili-api](https://github.com/xlz122/bilibili-server) - 提供B站web移动端api接口.js
...
- [bianka](https://github.com/VTB-LINK/bianka) - bilibili开放平台go-sdk.go
- [bilitool](https://github.com/timerring/bilitool) - 实现持久化登录、下载、查询、上传视频到 b 站等的 Python 工具库以及 cli.py|cli
- [biliTicker_gt](https://github.com/Amorter/biliTicker_gt) - biliTicker的自动验证模块.rust|py
...
- [fake_bilibili](https://github.com/Mioayaya/fake_bilibili) - kotlin仿哔哩哔哩动画app.kotlin|android
...
- [BiliBili_Checkin](https://github.com/arcturus-script/bilibili) - 腾讯云函数实现 BiliBili 每日观看视频、自动投币、分享、漫画签到、直播签到.py
- [bilicoin](https://github.com/r3inbowari/bilicoin) - B站自动投币工具 批量用户处理 Lv6经验补全 手机客户端二维码登录 支持docker.go|cli|docker
- [oh-my-helper](https://github.com/mozhu811/oh-my-helper) - Bilibili每日任务托管平台.jar
...
- [bilibili_checkin](https://github.com/Dangks/bilibili_checkin) - B站自动打卡程序，自动完成分享视频、观看视频、直播签到和漫画签到。通过使用GitHub Actions每日自动完成签到任务并获取相应的奖励.py
...
- [nonebot-plugin-bilichat](https://github.com/Well2333/nonebot-plugin-bilichat) - 一个通过 OpenAI 来对b站视频进行总结的多功能B站解析插件.py
...
- [BiliBili_Livestream_Reminder](https://github.com/hydrotho/BiliBili_Livestream_Reminder) - 一款监控哔哩哔哩直播间并通过 Telegram 机器人发送通知的工具.py|docker
- [BiliRoamingX](https://github.com/BiliRoamingX/BiliRoamingX) - 基于 ReVanced 实现的B站 Android 客户端增强模块.jar
- [biliMessagePush](https://github.com/Siroine/biliMessagePush) - 一款监控B站私信并推送消息提醒的软件.py|exe
- [QChatGPT_Plugin_Dynamic_Bilibili](https://github.com/zzseki/QChatGPT_Plugin_Dynamic_Bilibili) - 一个QChatGPT的插件，获取up主动态和直播开播提示，bot会以图片的方式进行通知.py
...
- [bilibili-ctl-web](https://github.com/ZeroDream-CN/bilibili-ctl-web) - Bilibili 评论管理工具，帮助你自动清理不想要的评论内容，支持关键字、黑名单以及正则表达式匹配.php|exe
- [bili2text](https://github.com/lanbinshijie/bili2text) - Bilibili视频转文字，一步到位，输入链接即可使用.py|cli
- [BiliMonitor](https://github.com/114514ns/BiliMonitor) - b站主播数据监测工具.go
- [bilibili-xml](https://github.com/ltzu929/bilibili-xml) - 弹幕数量可视化，方便切片man知道录播时弹幕热点（路灯）.py|exe
- [BiliHistoryFrontend](https://github.com/2977094657/BiliHistoryFrontend) - 获取b站历史记录，保存到本地数据库，可下载对应视频及时存档，生成详细的年度总结，自动化任务部署到服务器实现自动同步，以及自动发送日志邮件（前端）.vue|exe
- [BilibiliHistoryFetcher](https://github.com/2977094657/BilibiliHistoryFetcher) - 获取b站历史记录，保存到本地数据库，可下载对应视频及时存档，生成详细的年度总结，自动化任务部署到服务器实现自动同步，以及自动发送日志邮件（后端）.py
- [bilibili-gist-py](https://github.com/luyanci/bilibili-gist-py) - 将你的b站信息和近期投稿视频更新到你的pinned Gist.py
- [bilibili-Recommender](https://github.com/tLLWtG/bilibili-Recommender) - 一个基于 bilibili 用户行为数据和深度学习的个性化视频推荐系统.py
...
- [hexo-tag-bilibili-card](https://github.com/wherewhere/hexo-tag-bilibili-card) - 一个 Hexo 插件，在你的文章中插入哔哩哔哩卡片.js
- [bilibili-plugin](https://github.com/muedsa/bilibili-plugin) - 一个TvBox插件, 提供bilibili数据源.kotlin
- [Raycast-Bilibili](https://github.com/Fatpandac/Raycast-Bilibili) - 在 Raycast 快速浏览哔哩哔哩.ts
- [Rbilibili.el](https://github.com/lorniu/bilibili.el) - Emacs 中看 B 站.
- [HomeAssistant-BililiveRecorder](https://github.com/mikephemera/HomeAssistant-BililiveRecorder) - 让mikufans录播姬跑在 Home Assistant 里.shell
...
- [bilibili-activity-theme](https://github.com/xiaofeiTM233/bilibili-newsfeed-theme) - B站动态页主题.
...
- [bilibili_subscriber](https://github.com/BeiyanYunyi/bilibili_subscriber) - bilibili 第三方关注系统.dart
...
- [bilibili-comment-cleaning](https://github.com/Initsnow/bilibili-comment-cleaning) - BiliBili 删除历史评论.rust|exe|cli
- [Bili_Ticket_Monitor](https://github.com/TaiMiao/Bili_Ticket_Monitor) - 实时监测B站Bilibili会员购各种漫展开票、放票、回流票状态脚本(无抢票功能).py|cli
- [bilibili-backup](https://github.com/hzhilong/bilibili-backup) - 一键对B站账号进行数据备份和还原，方便账号数据迁移/快速转生(哗哩哗哩 bilibili).jar|cli
- [bilibili-quiz-slover](https://github.com/yuvenhol/bilibili-quiz-slover) - bilibili 自动解答工具.py|cli
