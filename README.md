...
- [BiliBili-To-English](https://github.com/LazyScar/BiliBili-To-English) - Translate BiliBili To English.
...
- [Tun-bili-tool](https://github.com/tuntun0609/tun-bili-tool) - bilibili 网页优化插件.
...
- [BewlyBewly](https://github.com/BewlyBewly/BewlyBewly) - 只需对您的 Bilibili 主页进行一些小更改即可.
...
- [BiliVideoInfo](https://github.com/iceriny/BiliVideoInfo) - B 站显示视频详情卡片，视频详情的侧面可以格式化视频数据并分享.
- [Bilibili 弹幕查询发送者](https://github.com/qianjiachun/bilibili-danmaku-tracker) - bilibili 弹幕查询发送者插件.
- [Bilibili-bangumi](https://github.com/kaze-k/bilibili-bangumi) - Bilibili Bangumi 是一个 bilibili 追番时间表的浏览器插件.
- [Bilibili-blacklist](https://github.com/snowraincloud/Bilibili-blacklist) - bilibili 首页视频过滤，支持黑名单、用户名、uid、播放量、点赞数等过滤，支持自定义过滤器.
...
- [BilibiliKeeper](https://github.com/xxcdd/BilibiliKeeper) - 使用 AI 智能分析，打造你的个性化 B 站信息流.
- [BilibiliSponsorBlock](https://github.com/hanydd/BilibiliSponsorBlock) - 跳过 B 站视频中恰饭片段的浏览器插件，移植自 SponsorBlock.
...
- [Bilibili-fullscreen-sc](https://github.com/eeelester/bilibili-fullscreen-sc) - 在 B 站看直播全屏时展示 SC.
- [Bilibili-live-recorder](https://github.com/zhw2590582/bilibili-live-recorder) - Bilibili 录播姬.
- [Bilibili-vup-stream-enhancer](https://github.com/eric2788/bilibili-vup-stream-enhancer) - 哔哩哔哩直播同传字幕过滤插件.
...
- [Bilibili 收藏夹自动分类](https://github.com/jqwgt/bilibili-favlist-classifier) - 自动分类 B 站收藏夹视，该脚本会根据视频的分区自动将视频分类到不同的收藏夹中，并在页面右侧显示读取视频的进度.
...
- [Bilibili【哔哩哔哩】 用户成分标签](https://github.com/lyzoris/Bilibili-UserComponentTag) - 根据 Bilibili 用户近期动态、粉丝勋章内容检测成分添加自定义标签.

### 主站脚本

- [B 站优质视频标记](https://github.com/clionertr/bilibili-video-High-quality-video-mark) - 在主页和视频界面计算 点赞数 / 视频播放量 >=0.042 标记为优质，过滤播放量小于 1000 的新视频.
...
- [Bilibili 专注模式](https://github.com/cndiandian/bilibili-focus) - 消除视频播放页面可能会吸引注意的元素，如右上角的消息未读数、右侧的广告、相关推荐、直播推荐等元素.
...
- [Bilibili-Gate](https://github.com/magicdawn/Bilibili-Gate) - Bilibili 自定义首页.
- [Bilibili-Markdown](https://github.com/LuckyPuppy514/Bilibili-Markdown) - B 站专栏 Markdown 编辑器.
- [Bilibili-Memo](https://github.com/Jayvin-Leung/Bilibili-Memo) - 站收藏视频备注 + 视频笔记下载 + 列表随机播放功能三合一，自动备份数据，跨浏览器使用.
...
- [Bilibili-Trackpad-Scroll-Reverser](https://github.com/MaxChang3/Bilibili-Trackpad-Scroll-Reverser) - 优化 b 站视频音量调节在触控板上的体验.
- [Bilibili-Web-Show-IP-Address](https://github.com/maxchang3/Bilibili-Web-Show-IP-Location) - 展示哔哩哔哩 Web 端的 IP 属地.
...
- [Bilibili-newvideo-tracker](https://github.com/lililili-student/bilibili-newvideo-tracker) - 当你手比脑子快，点到了换一换但是想看换一换之前的视频.
...
- [Bilimit](https://github.com/ABitGinger/Bilimit) - 这是一个油猴脚本，旨在通过自主限制，减少在 B 站无用内容上浪费的时间.
- [Bilitwin](https://github.com/liqi0816/bilitwin) - 超清 FLV 下载，FLV 合并，原生 MP4 下载，弹幕 ASS 下载，MKV 打包，播放体验增强...
- [ClickEase-for-Bilibili](https://github.com/uncharity/ClickEase-for-Bilibili) - 为哔哩哔哩设计的键盘操作方案.
- [Download-Pictures-from-Bilibili-Timeline](https://github.com/owendswang/Download-Pictures-from-Bilibili-Timeline) - 从 “Bilibili 动态” 页面下载图片.
- [Tampermonkey-removePrefix-bilibili](https://github.com/SoonIter/tampermonkey-removePrefix-bilibili) - 一个脚本解决 bilibili 视频选集中标题过长的问题.
- [Unlock-bilibili-PcBrowser-comment](https://github.com/QingXia-Ela/unlock-bilibili-PcBrowser-comment) - 新版 b 站评论区显示 IP 归属地与展示被隐藏评论.
...
- [B 站直播间定时发随机弹幕](https://github.com/Gamyou/bilibili-live-random-send) - 定时发送；凌晨打卡；设置随机弹幕；弹幕分组管理；各直播间弹幕互不干扰；无人值守参与、关闭天选时刻；直播间防休眠；隐藏模块简化直播间.
...
- [BLSPAM](https://github.com/ADJazzzz/BLSPAM) - Bilibili（B 站，Bili）直播独轮车脚本.
...
- [斗虫数据直播间可视化](https://greasyfork.org/zh-CN/scripts/435942) - 高能榜显示总人数.
...
- [BiLiBiLi_DanMu_Crawling](https://github.com/HengXin666/BiLiBiLi_DanMu_Crawling) - 爬取 B 站历史弹幕 / 全弹幕，支持高级弹幕.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [Bili-fav-sniffer](https://github.com/SummerLiu95/bili-fav-sniffer) - 哔哩哔哩收藏夹嗅探器，定时下载特定收藏夹的新视频到本地.![Shell](svg/shell.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [Bili-go](https://github.com/mouxiaohui/bili-go) - 一个 bilibili 视频命令行下载器.![Go](svg/go.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Bili-sync-yt-dlp](https://github.com/cap153/bili-sync-yt-dlp) - 使用 yt-dlp 结合 aria2 下载视频，仅下载收藏夹视频和海报.![Python](svg/python.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [Bili-sync](https://github.com/amtoaer/bili-sync) - 基于 python asyncio 编写的 bilibili 收藏夹同步下载工具.![Python](svg/python.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
...
- [BiliAuDown](https://github.com/Mikachu2333/BiliAuDown) - 利用 BBDown 以及 FFmpeg 下载哔哩哔哩的音频 / 视频并将其转换为 MP3 或者 flac 格式.![Windows](svg/windows.svg?raw=true)
...
- [BiliBiliVideoMerge](https://github.com/Server-WX/BiliBiliVideoMerge) - B 站缓存视频合并.![Java](svg/openjdk.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [BiliDown-GUI](https://github.com/WatererQuan/BiliDown-GUI) - 一个有简洁操作界面的哔哩哔哩视频下载器.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [BiliDownloader](https://github.com/Majjcom/BiliDownloader) - 超级好用的 GUI bilibili 视频下载器.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BiliFM](https://github.com/jingfelix/BiliFM) - 下载指定 up 主全部或指定数量的视频音频.![Python](svg/python.svg?raw=true)
- [BiliPala-Downloader](https://github.com/Kis2Show/BiliPala-Downloader) - 背靠 Bilibili 视频资源，只需要一个播放链接，即可自动化提取该播放列表下所有有声书资源至本地，自动截取封面，直接可用.![Python](svg/python.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [BiliResourceDownloader](https://github.com/LightQuanta/BiliResourceDownloader) - 多功能 B 站资源下载器.![Vue](svg/vue.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BiliTools](https://github.com/btjawa/BiliTools) - 哔哩哔哩工具箱.![TypeScript](svg/tsnode.svg?raw=true) ![Vue](svg/vue.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [Bilibili-Video-Downloader](https://github.com/MrBZBZ/Bilibili-Video-Downloader) - 支持扫码登录的超简洁 B 站视频下载器.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [Bilibili-api-client](https://github.com/judgeou/bilibili-api-client) - 哔哩哔哩视频下载器，支持 8k，hevc.![TypeScript](svg/tsnode.svg?raw=true)
- [Bilibili-app-cache-converter](https://github.com/BlueCitizens/bilibili-app-cache-converter) - 将哔哩哔哩手机客户端视频缓存文件批量合并成 mp4 视频和 ass 字幕.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [Bilibili-cheese-downloader](https://github.com/Misaka10571/bilibili-cheese-downloader) - bilibili 课程下载器，下载你已购买的或免费的 bilibili 课程.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [Bilibili-dl](https://github.com/Youguang-Zhou/bilibili-dl) -  Bilibili 视频解析工具模块.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Bilibili-download](https://github.com/imzusheng/bilibili-download) - bilibili 视频下载 Web 平台，免登录，支持下载 720p、480p、360p.![NodeJs](svg/nodejs.svg?raw=true)
...
- [Bilibili-manga-downloader](https://github.com/lanyeeee/bilibili-manga-downloader) - 哔哩哔哩漫画下载器.![Rust](svg/rust.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [Bilibili-manga-watermark-remover](https://github.com/lanyeeee/bilibili-manga-watermark-remover) - bilibili 漫画 哔哩哔哩漫画 B 漫 去水印工具，带图形界面，带下载功能，图形界面基于 Tauri.![Rust](svg/rust.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [BilibiliDown](https://github.com/nICEnnnnnnnLee/BilibiliDown) - (GUI - 多平台支持) 哔哩哔哩视频下载器，支持稍后再看、收藏夹、UP 主视频批量下载.![Java](svg/openjdk.svg?raw=true) ![Windows](svg/windows.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [BilibiliMemory](https://github.com/YuSitong1999/BilibiliMemory) - 获取在 哔哩哔哩 收藏夹中收藏的视频，保存到本地磁盘.![Python](svg/python.svg?raw=true)
- [BilibiliVideoDownloadFork](https://github.com/gxr404/BilibiliVideoDownloadFork) - 跨平台下载 bilibili 视频桌面端软件.![TypeScript](svg/tsnode.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BilibiliVideoDownload](https://github.com/BilibiliVideoDownload/BilibiliVideoDownload) - 跨平台下载哔哩哔哩视频桌面端软件，支持 windows、macOS、Linux.![Vue](svg/vue.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BilibiliVideoDownload](https://github.com/MunMunMiao/BilibiliVideoDownload) - 哔哩哔哩视频下载.![TypeScript](svg/tsnode.svg?raw=true)
- [Bilibili](https://github.com/0byteme/bilibili) - 使用 golang 编写的 bilibili 视频下载器.![Go](svg/go.svg?raw=true)
- [Bilibili_Downloader_Cli](https://github.com/open17/Bilibili-Downloader-Cli) - 一个轻量的 b 站下载器，支持下载 B 站视频，番剧，电影，电视剧等.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [Bilibili_fetcher](https://github.com/Bbdolt/Bilibili_fetcher) - B 站资源免费获取、提供在线播放音乐、本地播放音乐，提供 GUI 界面.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [Bilibili_video_download_reburn](https://github.com/RyrieNorth/bilibili_video_download_reburn) - 一个简单的命令行交互式 bilibili 视频下载工具.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Bilibilias](https://github.com/1250422131/bilibilias) - 哔哩哔哩视频缓存的辅助工具，一键解析缓存.![Java](svg/openjdk.svg?raw=true)
- [Bilidown](https://github.com/iuroc/bilidown) -  Bilibili 视频解析工具模块.![Go](svg/go.svg?raw=true) ![Windows](svg/windows.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Bilili](https://github.com/clostou/Bilili) - 哔哩哔哩番剧与影视下载.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Bilivideo_down](https://github.com/kangpeiqin/bilivideo_down) - 一款基于 Flutter 开发的桌面端 B 站视频下载器.![Dart](svg/dart.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [哔哩下载姬](https://github.com/yaobiao131/downkyicore) - 哔哩下载姬 (跨平台版) downkyi，哔哩哔哩网站视频下载工具，支持批量下载，支持 8K、HDR、杜比视界，提供工具箱（音视频提取、去水印等）.![C#](svg/csharp.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [哔哩哔哩漫画下载工具](https://github.com/KayneWang/bilibili-manga-downloader) - 通过 cli 的形式，将在哔漫已经购买过的漫画下载到本地，未购买的漫画无法下载全部图片.![Rust](svg/rust.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)

## 直播相关工具

- [BILiveChat.js](https://github.com/XL8Z/BiliBili_BiLiveChat.js) - 基于 PlayWithMe_JS 二次开发的纯前端弹幕展示板.![JavaScript](svg/javascript.svg?raw=true)
- [Bili-LiveLuckDraw](https://github.com/grtsinry43/Bili-LiveLuckDraw) - 一个 B 站直播抽奖工具，通过获取弹幕关键词进行抽奖.![TypeScript](svg/tsnode.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [Bili-bot](https://github.com/orangelckc/bili-bot) - 哔哩哔哩 - 直播间管家机器人.![TypeScript](svg/tsnode.svg?raw=true)
- [Bili-live-machine](https://github.com/phy-lei/bili-live-machine) - bilibili 直播姬 - 弹幕姬.![TypeScript](svg/tsnode.svg?raw=true)
- [Bili-recorder](https://github.com/chocotan/bili-recorder) - 这是一个 bilibili 直播录制工具.![Java](svg/openjdk.svg?raw=true)
- [Bili-shadowreplay](https://github.com/Xinrea/bili-shadowreplay) - bilibili 直播实时切片工具.![Rust](svg/rust.svg?raw=true)
- [Bili2.0](https://github.com/yjqiang/bili2.0) - Python3 实现的 Bilibili 直播助手.![Python](svg/python.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [BiliBili-Live-Recorder](https://github.com/CNXiaozhiy/BiliBili-Live-Recorder) - 哔哩哔哩全自动直播录制器，支持对接适配器（OneBot 协议的 QQ 机器人）.![TypeScript](svg/tsnode.svg?raw=true)
- [BiliBiliLiveAutoRec](https://github.com/qiaoshouzi/BiliBiliLiveAutoRec) - 自动录播脚本.![Python](svg/python.svg?raw=true)
- [BiliBiliSongHime](https://github.com/SoingSaika/BiliBiliSongHime) - 哔哩哔哩直播点歌姬.![Java](svg/openjdk.svg?raw=true)
- [BiliDown](https://github.com/Nemo2011/BiliDown) - 哔哩哔哩命令行下载器.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [BiliLine_GUI](https://github.com/RemKeeper/BiliLine_GUI) - 哔哩哔哩排队姬 GUI 版本.![Go](svg/go.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BiliLive-Auto-Streaming](https://github.com/KimmyXYC/BiliLive-Auto-Streaming) - 哔哩哔哩自动直播.![Python](svg/python.svg?raw=true)
- [BiliLive-tools](https://github.com/renmu123/biliLive-tools) - B 站录播一站式工具，支持录播姬 webhook 自动上传.![Vue](svg/vue.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BiliLiveChat](https://github.com/BanqiJane/BiliLiveChat) - 纯前端网页简易 B 站弹幕姬，并带语音读弹幕.![JavaScript](svg/javascript.svg?raw=true)
- [BiliLiveNotification](https://github.com/yunhuanyx/biliLiveNotification) - b 站直播开播提醒.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [Bilibili-Live-Record](https://github.com/chandou-code/Bilibili-Live-Record) - HTML+Flask 自动爬取 up 主的《直播回放》 一键实现已看、撤回、更新、多 up 录播等功能.
...
- [Bilibili-mac](https://github.com/yielde/bilibili-mac) - bilibili 直播 mac 桌面小软件，手机扫码登录，获取推流码开播下播.![C++](svg/cplusplus.svg?raw=true)
...
- [BilibiliDanmuRobot](https://github.com/xbclub/BilibiliDanmuRobot) - bilibili 直播弹幕机器人.![Go](svg/go.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BilibiliLiveMonitorDocker](https://github.com/LambdaExpression/BilibiliLiveMonitorDocker) - bilibili 直播监控统计.![Java](svg/openjdk.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [BilibiliLiveNotifier_WPF](https://github.com/ciiim/BilibiliLiveNotifier_WPF) - Bilibili 直播通知小工具.![C#](svg/csharp.svg?raw=true)
...
- [Bilibili_Song_Player](https://github.com/mk-ling/Bilibili_Song_Player) - 利用 Selenium 操控 Chrome 的直播点歌软件.![Python](svg/python.svg?raw=true)
...
- [Bilibili_gift_screenshot](https://github.com/Ikaros-521/bilibili_gift_screenshot) - 用于哔哩哔哩直播时，用户送礼物时触发截图，可自定义截图区域.![Python](svg/python.svg?raw=true)
...
- [Bililiveauto](https://github.com/Moraxyc/Bililiveauto) - 兼容哔哩哔哩录播姬的自动转封装、自动上传、弹幕转码脚本.![JavaScript](svg/javascript.svg?raw=true)
...
- [Biliupforjava](https://github.com/mwxmmy/biliupforjava) - 用于 b 站录播姬，mikufans 录播姬，blrec 的， 基于 WebHook 的全自动上传投稿工具，web 页面配置.![Java](svg/openjdk.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
...
- [Bilive](https://github.com/timerring/bilive) - 7 x 24 小时无人监守录制、渲染弹幕、自动上传，启动项目，人人都是录播员.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Blive-ws](https://github.com/champkeh/blive-ws) - B 站直播间实时弹幕采集.![NodeJs](svg/nodejs.svg?raw=true)
- [BliveCharts](https://github.com/Seyyu0015/BliveCharts) - OBS 用直播插件，直播观众贡献排行榜.![Python](svg/python.svg?raw=true)
...
- [Comen](https://github.com/3Shain/Comen) - 直播用弹幕栏.![TypeScript](svg/tsnode.svg?raw=true)
- [DDRecorder](https://github.com/AsaChiri/DDRecorder) - Headless 全自动 B 站直播录播、切片、上传一体工具.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [DDTV](https://github.com/CHKZL/DDTV) - 可进行哔哩哔哩直播开播提醒、自动录制、在线播放、合并、转码、上传的跨平台部署工具.![C#](svg/csharp.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [DD_Monitor-android-kotlin](https://github.com/congHu/DD_Monitor-android-kotlin) - DD 监控室安卓版.![Kotlin](svg/kotlin.svg?raw=true)
...
- [Iceborne](https://github.com/liuxian496/iceborne) - Iceborne 弹幕播报，是一个简易版的，支持 mac os 系统的弹幕播报应用.![TypeScript](svg/tsnode.svg?raw=true)
- [LiveAutoRecord](https://github.com/WhiteMinds/LiveAutoRecord) - 基于 Electron 的多平台直播自动录制软件.![TypeScript](svg/tsnode.svg?raw=true)
...
- [OlivaBiliLive](https://github.com/HsiangNianian/OlivaBiliLive) - 可插件化管理的 B 站直播间机器人 (插件基于 OlivOS).![Python](svg/python.svg?raw=true)
- [Php-bilibili-danmu](https://github.com/zxc7563598/php-bilibili-danmu) - B 站机器人弹幕监控，礼物答谢、定时广告、关注感谢，自动回复等，PHP 版本弹幕姬，基于 workman.![PHP](svg/php.svg?raw=true) ![Cli](svg/terminal.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
...
- [Vue-bili-danmaku](https://github.com/Drelf2018/vue-bili-danmaku) - 基于 Vue3 的 b 站直播弹幕姬.![Vue](svg/vue.svg?raw=true)
...
- [Bili-music-segmenter](https://github.com/lovegaoshi/bili-music-segmenter) - b 站自动录播 + 歌切 + 上传脚本，支持 docker 部署.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
...
- [Biliup-app](https://github.com/biliup/biliup-app) - b 站全平台投稿客户端，支持多 p 投稿.![Svelte](svg/svelte.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [Biliup-go](https://github.com/XiaoMiku01/biliup-go) - B 站命令行投稿工具 Golang 实现.![Go](svg/go.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Biliup-rs](https://github.com/biliup/biliup-rs) - 哔哩哔哩命令行投稿工具，支持多 p、线路选择.![Rust](svg/rust.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Biliup](https://github.com/biliup/biliup) - 支持自动录制各大直播平台实时流，上传到哔哩哔哩.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
...
- [Youtube2Bili](https://github.com/INSIinc/Youtube2Bili) - 一个能够从任何你想要的 YouTuber 那里下载视频并上传到 Bilibili 的 Python 脚本.![Python](svg/python.svg?raw=true)
- [Youtube2bilibili](https://github.com/assassinliujie/youtube2bilibili) - 油管视频 / 频道 一键搬运到 b 站脚本.![Python](svg/python.svg?raw=true)
- [YoutubeToBilibiliHelp](https://github.com/gaoxiaoduan/YoutubeToBilibiliHelp) - 将油管视频自动上传到 b 站.![TypeScript](svg/tsnode.svg?raw=true)
...
- [BiLiveir](https://github.com/GoldrenEggs/BiLiveir) - 异步 bilibili 直播信息流（弹幕、抽奖、礼物等）处理框架.![Python](svg/python.svg?raw=true)
- [Bianka](https://github.com/VTB-LINK/bianka) - bilibili 开放平台 go-sdk.![Go](svg/go.svg?raw=true)
- [Bili-api](https://github.com/simon300000/bili-api) - Bilibili Node.js API.![NodeJs](svg/nodejs.svg?raw=true)
- [Bili-auth](https://github.com/icyux/bili-auth) - 第三方哔哩哔哩 OAuth API，基于私信鉴权.![Python](svg/python.svg?raw=true)
...
- [BiliSDK](https://github.com/yanyvpingsheng/biliSDK) - 哔哩哔哩直播弹幕 JAVA-SDK.![Java](svg/openjdk.svg?raw=true)
- [BiliTicker_gt](https://github.com/Amorter/biliTicker_gt) - biliTicker 的自动验证模块.![Rust](svg/rust.svg?raw=true) ![Python](svg/python.svg?raw=true)
...
- [Bilibili-api](https://github.com/xlz122/bilibili-server) - 提供 B 站 web 移动端 api 接口.![JavaScript](svg/javascript.svg?raw=true)
- [Bilibili-bullet](https://github.com/79W/bilibili-bullet) - bilibili 直播弹幕实时 WebSocket 爬取.![Vue](svg/vue.svg?raw=true)
- [Bilibili-captain](https://github.com/Ninzore/bilibili-captain) - 简易 B 站 API 调用.![TypeScript](svg/tsnode.svg?raw=true)
...
- [Bililive-rs](https://github.com/LightQuantumArchive/bililive-rs) - Simple stream-based bilibili live client libraries.![Rust](svg/rust.svg?raw=true)
...
- [Bilitool](https://github.com/timerring/bilitool) - 实现持久化登录、下载、查询、上传视频到 b 站等的 Python 工具库以及 cli.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Bilive-danmaku](https://github.com/4t145/bilive-danmaku) - b 站直播 api，将 bilibili 直播间的 wss 连接转化成事件.![Rust](svg/rust.svg?raw=true)
- [Blivedm-go](https://github.com/Akegarasu/blivedm-go) - bilibili 直播弹幕 golang 库.![Go](svg/go.svg?raw=true)
...
- [ATV-Bilibili-demo](https://github.com/yichengchen/ATV-Bilibili-demo) - BiliBili tvOS 客户端 Demo.![Swift](svg/swift.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [Azusa-player-mobile](https://github.com/lovegaoshi/azusa-player-mobile) - 移动端的第三方 b 站音乐播放器.![TypeScript](svg/tsnode.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [BBLL](https://github.com/xiaye13579/BBLL) - 一个第三方哔哩哔哩 TV 和 Pad 客户端.![Android](svg/android.svg?raw=true)
...
- [Bili-fm](https://github.com/vst93/bili-fm) - 通过音频来听 B 站节目，你可以把它作为一个音乐播放器，也可以用来作为知识学习的工具.![TypeScript](svg/tsnode.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [BiliNeo](https://github.com/Predidit/BiliNeo) - 又一个第三方 Bilibili 客户端，支持 Android 和 Windows.![Windows](svg/windows.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [BiliSpirit](https://github.com/JamesBaiJun/BiliSpirit) - WPF B 站 (Bilibili) 工具，查看热门视频，动态，及历史记录等功能.![C#](svg/csharp.svg?raw=true) ![Web](svg/edge.svg?raw=true)
- [BiliStart.WinUI3](https://github.com/BlameTwo/BiliStart.WinUI3-Preview) - BiliStart 的衍生版本，为 BiliBili 网站的第三方 Windows 本地客户端.![C#](svg/csharp.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BiliStart](https://github.com/BlameTwo/BiliStart) - B 站第三方客户端.![C#](svg/csharp.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BiliTerminal2](https://github.com/Re-BiliTerminal/BiliTerminal2) - 轻量的安卓第三方 B 站客户端，哔哩终端的 Fork.![Java](svg/openjdk.svg?raw=true)
- [Bili_you](https://github.com/lucinhu/bili_you) - 一个用 flutter 制作的第三方 B 站客户端.![Dart](svg/dart.svg?raw=true) ![Android](svg/android.svg?raw=true) ![Linux](svg/linux.svg?raw=true)
...
- [Bilibili-linux](https://github.com/msojocs/bilibili-linux) - 基于哔哩哔哩官方客户端修改的 Linux 版本.![NodeJs](svg/nodejs.svg?raw=true) ![Windows](svg/windows.svg?raw=true) ![Linux](svg/linux.svg?raw=true)
- [Bilibili-ports](https://github.com/reekystive/bilibili-ports) - 哔哩哔哩官方客户端移植.![TypeScript](svg/tsnode.svg?raw=true) ![Windows](svg/windows.svg?raw=true) ![Linux](svg/linux.svg?raw=true) ![MacOS](svg/apple.svg?raw=true)
- [BilibiliHD2](https://github.com/duzhaokun123/BilibiliHD2) - 非官方哔哩哔哩客户端.![Kotlin](svg/kotlin.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [BilibiliLiveTV](https://github.com/MUedsa/BilibiliLiveTV) - 哔哩哔哩直播 Android TV APP.![Java](svg/openjdk.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [BilibiliTv](https://github.com/peacefulprogram/BilibiliTv) - B 站第三方客户端.![Kotlin](svg/kotlin.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [Bilibili](https://github.com/YeZC/bilibili) - 高仿 Bilibili.![Kotlin](svg/kotlin.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [Bilibili](https://github.com/hdtls/bilibili) - 基于 Flutter 的 b 站客户端.![MacOS](svg/apple.svg?raw=true)
- [Bilibili](https://github.com/keluokeda/Bilibili) - Bilibili 第三方客户端，支持手机和 tv.![Kotlin](svg/kotlin.svg?raw=true) ![Android](svg/android.svg?raw=true)
...
- [Bv](https://github.com/aaa1115910/bv) - 哔哩哔哩 的第三方 Android TV 应用.![Kotlin](svg/kotlin.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [Darock-Bili](https://github.com/Darock-Studio/Darock-Bili) - Apple Watch 上的 B 站客户端.![Swift](svg/swift.svg?raw=true)
- [Fake_bilibili](https://github.com/Mioayaya/fake_bilibili) - kotlin 仿哔哩哔哩动画 app.![Kotlin](svg/kotlin.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [HyperBilibili](https://github.com/Searchstars/HyperBilibili) - 在 Vela 嵌入式设备上基于 QuickApp 实现的第三方 B 站客户端.![TypeScript](svg/tsnode.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [MeowBili-For-Zepp-OS](https://github.com/tiqwq/MeowBili-For-Zepp-OS) - A BiliBili jsapp for Amazfit Zepp OS.![JavaScript](svg/javascript.svg?raw=true)
- [Pilipala](https://github.com/guozhigq/pilipala) - PiliPala 是使用 Flutter 开发的 BiliBili 第三方客户端.![Android](svg/android.svg?raw=true)
- [Re-WearBili](https://github.com/SpaceXC/Re-WearBili) - 一个手表上的第三方 Bilibili 客户端.![Kotlin](svg/kotlin.svg?raw=true)
- [React-bilibili](https://github.com/dxx/react-bilibili) - 高仿 B 站 web 移动端.![NodeJs](svg/nodejs.svg?raw=true) ![Android](svg/android.svg?raw=true)
- [TikBili](https://github.com/todo-proj/TikBili) - 用刷抖音的方法刷 B 站视频.![Kotlin](svg/kotlin.svg?raw=true) ![Android](svg/android.svg?raw=true)
...
- [Wiliwili](https://github.com/xfangfang/wiliwili) - 专为手柄控制设计的第三方跨平台 B 站客户端，目前可以运行在 PC 全平台和 Nintendo Switch 上.![C++](svg/cplusplus.svg?raw=true) ![Windows](svg/windows.svg?raw=true) ![Linux](svg/linux.svg?raw=true) ![MacOS](svg/apple.svg?raw=true)
- [WristBilibili](https://github.com/luern0313/WristBilibili) - 腕上哔哩，在智能手表上集成一个有简单功能的 b 站客户端.![Java](svg/openjdk.svg?raw=true)
- [哔哩助理](https://github.com/Richasy/Bili.Copilot) - 哔哩哔哩用户的个人助理.![C#](svg/csharp.svg?raw=true) ![Windows](svg/windows.svg?raw=true)

## 每日任务

> 用于做每日任务快速升级的程序。

- [BiliBiliToolPro](https://github.com/RayWangQvQ/BiliBiliToolPro) - B 站（bilibili）自动任务工具，支持 docker、青龙、腾讯云函数等多种部署方式.![C#](svg/csharp.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [BiliBili_Checkin](https://github.com/arcturus-script/bilibili) - 腾讯云函数实现 BiliBili 每日观看视频、自动投币、分享、漫画签到、直播签到.![Python](svg/python.svg?raw=true)
- [BiliBili_Daily-tasks](https://github.com/wenshancheng/BiliBili_Daily-tasks) - Python 脚本自动完成 B 站每日经验任务、直播签到等.![Python](svg/python.svg?raw=true)
- [BiliHelper-personal](https://github.com/lkeme/BiliHelper-personal) - 哔哩哔哩助手 - PHP 版.![PHP](svg/php.svg?raw=true)
- [BiliOutils](https://github.com/catlair/BiliOutils) - 直播心跳，漫画每日阅读积分，漫读券兑换，赛事竞猜.![TypeScript](svg/tsnode.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [Bilibili-helper](https://github.com/RealBeBetter/bilibili-helper) - bilibili 签到助手.![Java](svg/openjdk.svg?raw=true)
- [BilibiliDailyUp](https://github.com/Wyatt1026/BilibiliDailyUp) - 哔哩哔哩每日任务脚本.![Python](svg/python.svg?raw=true)
- [BilibiliTask](https://github.com/JiaQiZJQ/bilibiliTask) - B 站签到利器.![Java](svg/openjdk.svg?raw=true)
...
- [Bilibili_checkin](https://github.com/Dangks/bilibili_checkin) - B 站自动打卡程序，自动完成分享视频、观看视频、直播签到和漫画签到。通过使用 GitHub Actions 每日自动完成签到任务并获取相应的奖励.![Python](svg/python.svg?raw=true)
...
- [Oh-my-helper](https://github.com/mozhu811/oh-my-helper) - Bilibili 每日任务托管平台.![Java](svg/openjdk.svg?raw=true)
...
- [BiliBili_Livestream_Reminder](https://github.com/hydrotho/BiliBili_Livestream_Reminder) - 一款监控哔哩哔哩直播间并通过 Telegram 机器人发送通知的工具.![Python](svg/python.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [BiliMessagePush](https://github.com/Siroine/biliMessagePush) - 一款监控 B 站私信并推送消息提醒的软件.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BiliRoamingX](https://github.com/BiliRoamingX/BiliRoamingX) - 基于 ReVanced 实现的 B 站 Android 客户端增强模块.![Java](svg/openjdk.svg?raw=true)
...
- [BilivedioSnap](https://github.com/Arisuakip/bilivedioSnap) - HoshinoBot 插件，把群友的哔哩哔哩小程序转成预览图.![Python](svg/python.svg?raw=true)
- [BotBiliBili](https://github.com/Coloryr/BotBiliBili) - 一个基于 ColorMirai 的 B 站机器人.![C#](svg/csharp.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [Nonebot-plugin-bilichat](https://github.com/Well2333/nonebot-plugin-bilichat) - 一个通过 OpenAI 来对 b 站视频进行总结的多功能 B 站解析插件.![Python](svg/python.svg?raw=true)
...
- [Nonebot_plugin_bilibilibot](https://github.com/TDK1969/nonebot_plugin_bilibilibot) - 基于 Nonebot2 的 bilibili 通知插件，可将 up 主，主播以及番剧的更新 / 直播动态推送到 QQ.![Python](svg/python.svg?raw=true)
- [Nonebot_plugin_bilifan](https://github.com/Agnes4m/nonebot_plugin_bilifan) - 基于 nonebot2 的插件，刷 b 站直播间牌子.![Python](svg/python.svg?raw=true)
- [Nonebot_plugin_searchBiliInfo](https://github.com/Ikaros-521/nonebot_plugin_searchBiliInfo) - 适用于 nonebot2 v11 的 b 站用户粉丝、舰团信息查询插件.![Python](svg/python.svg?raw=true)
- [QChatGPT_Plugin_Dynamic_Bilibili](https://github.com/zzseki/QChatGPT_Plugin_Dynamic_Bilibili) - 一个 QChatGPT 的插件，获取 up 主动态和直播开播提示，bot 会以图片的方式进行通知.![Python](svg/python.svg?raw=true)
...
- [Bili2text](https://github.com/lanbinleo/bili2text) - Bilibili 视频转文字，一步到位，输入链接即可使用.![Python](svg/python.svg?raw=true)
- [Bili2text](https://github.com/lanbinshijie/bili2text) - Bilibili 视频转文字，一步到位，输入链接即可使用.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
...
- [BiliHistoryFrontend](https://github.com/2977094657/BiliHistoryFrontend) - 获取 b 站历史记录，保存到本地数据库，可下载对应视频及时存档，生成详细的年度总结，自动化任务部署到服务器实现自动同步，以及自动发送日志邮件（前端）.![Vue](svg/vue.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BiliMonitor](https://github.com/114514ns/BiliMonitor) - b 站主播数据监测工具.![Go](svg/go.svg?raw=true)
- [BiliSpeech2Text](https://github.com/Frewen/BiliSpeech2Text) - 通过下载视频、提取音频、分割音频，并使用 OpenAI 的 Whisper 模型将语音转换为文本.![Python](svg/python.svg?raw=true)
- [BiliUserInfo](https://github.com/Ghauster/BiliUserInfo) - Bilibili 用户精确数据爬虫.![Python](svg/python.svg?raw=true)
- [BiliVideo2article](https://github.com/w0fv1/biliVideo2article) - 利用哔哩哔哩的 API 获取视频信息和评论，通过 OpenAI 的 API 生成文章，并将生成的文章保存为 Markdown 格式.![Python](svg/python.svg?raw=true)
- [Bili_Realtime_Data](https://github.com/CzJam/Bili_Realtime_Data) - Bilibili 粉丝与视频实时数据统计.![PHP](svg/php.svg?raw=true)
- [Bilibili-Recommender](https://github.com/tLLWtG/bilibili-Recommender) - 一个基于 bilibili 用户行为数据和深度学习的个性化视频推荐系统.![Python](svg/python.svg?raw=true)
- [Bilibili-archiver](https://github.com/XiaoMiku01/bilibili-archiver) - 自动同步 B 站收藏夹投稿、弹幕、元数据至本地.![Go](svg/go.svg?raw=true) ![Cli](svg/terminal.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [Bilibili-barrage-analysis](https://github.com/moyuweiqing/bilibili-barrage-analysis) - bilibili 弹幕分析，包含爬虫、词云分析、词频分析、情感分析、构建衍生指标，可视化.![Python](svg/python.svg?raw=true)
- [Bilibili-catcher](https://github.com/ImMappyJ/bilibili-catcher) - B 站投稿实时生成图像、根据 B 站用户生成用户画像、获取视频下载地址的网站.![PHP](svg/php.svg?raw=true)
- [Bilibili-comment-crawler](https://github.com/1dyer/bilibili-comment-crawler) - 用于爬取 Bilibili（B 站）视频评论的爬虫，支持爬取一级评论及二级回复，并将数据导出为 CSV 文件.![Python](svg/python.svg?raw=true)
- [Bilibili-ctl-web](https://github.com/ZeroDream-CN/bilibili-ctl-web) - Bilibili 评论管理工具，帮助你自动清理不想要的评论内容，支持关键字、黑名单以及正则表达式匹配.![PHP](svg/php.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [Bilibili-gist-py](https://github.com/luyanci/bilibili-gist-py) - 将你的 b 站信息和近期投稿视频更新到你的 pinned Gist.![Python](svg/python.svg?raw=true)
...
- [Bilibili-xml](https://github.com/ltzu929/bilibili-xml) - 弹幕数量可视化，方便切片 man 知道录播时弹幕热点（路灯）.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BilibiliCommentScraper](https://github.com/Ghauster/BilibiliCommentScraper) - B 站视频评论爬虫 Bilibili 完整爬取评论数据.![Python](svg/python.svg?raw=true)
...
- [BilibiliCrawle](https://github.com/reisen7/bilibiliCrawle) - 这个项目是一个爬虫应用，旨在从 B 站提取弹幕数据，评论数据.![Python](svg/python.svg?raw=true)
- [BilibiliDanmuCrawler](https://github.com/vinouno/BilibiliDanmuCrawler) - 弹幕词云生成器.![Python](svg/python.svg?raw=true)
- [BilibiliHistoryFetcher](https://github.com/2977094657/BilibiliHistoryFetcher) - 获取 b 站历史记录，保存到本地数据库，可下载对应视频及时存档，生成详细的年度总结，自动化任务部署到服务器实现自动同步，以及自动发送日志邮件（后端）.![Python](svg/python.svg?raw=true)
- [BilibiliHistoryFetcher](https://github.com/2977094657/BilibiliHistoryFetcher) - 该项目用于获取、处理、分析和可视化哔哩哔哩用户的观看历史数据.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true) ![Windows](svg/windows.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
...
- [VisualBilibili](https://github.com/Nomination-NRB/VisualBilibili) - 爬取 B 站 up 视频详细信息，并进行可视化.![Python](svg/python.svg?raw=true) ![JavaScript](svg/javascript.svg?raw=true)

## 相关插件

> 适用于其他平台/客户端的与B站相关的插件。

- [BiliChromePlugin](https://github.com/EZ118/BiliChromePlugin) - 官方发布的适用于 BiliScape (BiliChrome) 的 JS 插件.![JavaScript](svg/javascript.svg?raw=true)
- [BiliLoader](https://github.com/JoinChang/BiliLoader) - BiliLoader 是一款为哔哩哔哩 PC 客户端实现的插件加载器.![JavaScript](svg/javascript.svg?raw=true)
- [BiliSearchPlugin](https://github.com/NanSsye/BiliSearchPlugin) - 用于 XYBotV2 搜索小破站番剧链接的插件.![Python](svg/python.svg?raw=true)
- [BiliURL](https://github.com/BestBcz/BiliURL) - 解析 QQ 中分享的哔哩哔哩小程序视频并下载发送的 miraiQQ 机器人插件.![Kotlin](svg/kotlin.svg?raw=true)
...
- [Bilibili-bangumi-component](https://github.com/yixiaojiu/bilibili-bangumi-component) - 展示 bilibili 与 Bangumi 追番列表的 WebComponent 组件.![TypeScript](svg/tsnode.svg?raw=true)
- [Bilibili-plugin](https://github.com/muedsa/bilibili-plugin) - 一个 TvBox 插件，提供 bilibili 数据源.![Kotlin](svg/kotlin.svg?raw=true)
...
- [DDbot-advanced-bilibili-notify](https://github.com/QuincyZhang03/DDbot-advanced-bilibili-notify) - DDbot 的 B 站直播推送扩展功能后端，可配合模板实现主播更改直播标题通知，以及直播时长显示.![C#](svg/csharp.svg?raw=true)
- [Douban-bilibili-helper](https://github.com/Dean-Moriarty/douban-bilibili-helper) - 这是一个浏览器扩展程序，可以在豆瓣电影和图书页面上显示相关的 B 站视频内容.![JavaScript](svg/javascript.svg?raw=true)
- [Gopeed-extension-bilibili](https://github.com/monkeyWie/gopeed-extension-bilibili) - Bilibili video download extension of gopeed.![JavaScript](svg/javascript.svg?raw=true)
...
- [Hexo-tag-bilibili-card](https://github.com/wherewhere/hexo-tag-bilibili-card) - 一个 Hexo 插件，在你的文章中插入哔哩哔哩卡片.![JavaScript](svg/javascript.svg?raw=true)
- [HomeAssistant-BililiveRecorder](https://github.com/mikephemera/HomeAssistant-BililiveRecorder) - 让 mikufans 录播姬跑在 Home Assistant 里.![Shell](svg/shell.svg?raw=true)
...
- [OBSscripts-bilibili-live](https://github.com/lanyangyin/OBSscripts-bilibili-live) - obs 用于 B 站直播的插件.![Python](svg/python.svg?raw=true)
...
- [Plugin.bilibili-manga](https://github.com/RuliaReader/plugin.bilibili-manga) - 用于阅读哔哩哔哩漫画的 Rulia 插件.![JavaScript](svg/javascript.svg?raw=true)
- [Plugin.video.bili](https://github.com/chen310/plugin.video.bili) - 哔哩哔哩 Kodi 插件.![Python](svg/python.svg?raw=true)
- [PowerToysRun-Bilibili](https://github.com/Whuihuan/PowerToysRun-Bilibili) - PowerToys Run: 哔哩哔哩解析插件.![C#](svg/csharp.svg?raw=true)
- [Raycast-Bilibili](https://github.com/Fatpandac/Raycast-Bilibili) - 在 Raycast 快速浏览哔哩哔哩.![TypeScript](svg/tsnode.svg?raw=true)
- [Rbilibili.el](https://github.com/lorniu/bilibili.el) - Emacs 中看 B 站.
...
- [Bili-hardcore](https://github.com/Karben233/bili-hardcore) - B 站硬核会员自动答题工具，利用 LLM 实现智能答题功能.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
...
- [BiliRaku](https://github.com/SkyBlue997/BiliRaku) - 基于 B 站 API 和 DeepSeek 的硬核会员自动答题工具.![Python](svg/python.svg?raw=true)
...
- [BiliShareMall](https://github.com/mikumifa/BiliShareMall) - 图形化 B 站 会员购 魔力赏 市集 爬虫 搜索 脚本.![TypeScript](svg/tsnode.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BiliTickerBuy](https://github.com/mikumifa/biliTickerBuy) - 开源免费，简单易用，图形界面，速度极快的 B 站会员购辅助工具.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true) ![Docker](svg/docker.svg?raw=true)
- [BiliUniverse](https://github.com/BiliUniverse/Universe) - 哔哩哔哩流媒体平台功能增强系列模块.
- [Bili_Ticket_Monitor](https://github.com/TaiMiao/Bili_Ticket_Monitor) - 实时监测 B 站 Bilibili 会员购各种漫展开票、放票、回流票状态脚本 (无抢票功能).![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
...
- [Bilibili-activity-theme](https://github.com/xiaofeiTM233/bilibili-newsfeed-theme) - B 站动态页主题.
- [Bilibili-backup](https://github.com/hzhilong/bilibili-backup) - 一键对 B 站账号进行数据备份和还原，方便账号数据迁移 / 快速转生 (哗哩哗哩 bilibili).![Java](svg/openjdk.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Bilibili-comment-cleaning](https://github.com/Initsnow/bilibili-comment-cleaning) - BiliBili 删除历史评论.![Rust](svg/rust.svg?raw=true) ![Windows](svg/windows.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
...
- [Bilibili-lucky](https://github.com/wojiangkuanglong/bilibili-lucky) - B 站抽奖脚本.![JavaScript](svg/javascript.svg?raw=true)
- [Bilibili-parse](https://github.com/injahow/bilibili-parse) - bilibili 视频解析 API.![PHP](svg/php.svg?raw=true)
- [Bilibili-quiz-slover](https://github.com/yuvenhol/bilibili-quiz-slover) - bilibili 自动解答工具.![Python](svg/python.svg?raw=true) ![Cli](svg/terminal.svg?raw=true)
- [Bilibili-skin](https://github.com/Rovniced/bilibili-skin) - 哔哩哔哩个性装扮主题.
- [Bilibili-stats-badges](https://github.com/lonelyion/bilibili-stats-badges) - Bilibili 状态徽章.![JavaScript](svg/javascript.svg?raw=true)
- [Bilibili-stats](https://github.com/zmh-program/bilibili-stats) - 动态生成 B 站用户简介 SVG 图像.![TypeScript](svg/tsnode.svg?raw=true)
- [Bilibili-viewcount-booster](https://github.com/liqwang/bilibili-viewcount-booster) - B 站刷播放量脚本.![Python](svg/python.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [BilibiliFans](https://github.com/Bernankez/BilibiliFans) - 制作你的粉丝装扮卡片.![Vue](svg/vue.svg?raw=true)
...
- [Bilibili_senior_llm](https://github.com/JavaZeroo/bilibili_senior_llm) - b 站硬核会员考试 llm 自动答题.![Python](svg/python.svg?raw=true)
- [Bilibili_subscriber](https://github.com/BeiyanYunyi/bilibili_subscriber) - bilibili 第三方关注系统.![Dart](svg/dart.svg?raw=true)
- [Bilibili_unread](https://github.com/powersee/bilibili_unread) - B 站未读消息提示器.![Python](svg/python.svg?raw=true)
- [Bilibili_video_convert_pdf](https://github.com/lrzjbyx/Bilibili_video_convert_pdf) - 视频转换成关键帧 PDF.![Python](svg/python.svg?raw=true)
- [Bilibilijson2srt](https://github.com/Poempoat/bilibilijson2srt) - 将 Bilibili 的 CC 字幕（JSON 格式）文件转换为 srt.![C++](svg/cplusplus.svg?raw=true) ![Windows](svg/windows.svg?raw=true)
- [Bilibiliplayer](https://github.com/MotooriKashin/bilibiliplayer) - 旧版 Bilibili 播放器，使用 typescript 进行了重构.![TypeScript](svg/tsnode.svg?raw=true)
...
- [Biliroaming-ts-server-vercel](https://github.com/bili-vd-bak/biliroaming-ts-server-vercel) - 为 BiliRoaming、哔哩 UWP 等提供支持。包括支持基本功能、搜索替换、黑白名单的哔哩漫游服务端.![TypeScript](svg/tsnode.svg?raw=true)
...
- [QtmdBili](https://github.com/xvhuan/qtmdBili) - 收集哔哩哔哩中的各种营销号，然后一键拉黑.![JavaScript](svg/javascript.svg?raw=true)
- [Tool-Asoul-Music](https://github.com/sudoskys/Tool-Asoul-Music) - 哔哩哔哩收藏夹提取音频推送到 TG 频道且支持自动搜索筛选推送.![Python](svg/python.svg?raw=true)

## 贡献

请查看[贡献指南](https://github.com/HCLonely/awesome-bilibili-extra/blob/master/CONTRIBUTING.md).

<!-- Sort Time: 2025-05-27 00:57:52 +00:00 -->
