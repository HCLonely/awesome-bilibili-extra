...
- [DDTV2](https://github.com/CHKZL/DDTV2) - 可进行哔哩哔哩直播开播提醒、自动录制、在线播放、合并、转码、上传的跨平台部署工具.
...
- [Biliup](https://github.com/ForgQi/biliup) - Stream download and upload, not only for bilibili.
